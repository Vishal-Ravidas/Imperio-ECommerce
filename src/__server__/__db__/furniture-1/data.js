...
export const categoryNavigation = [{
  ...
  categoryItem: [{
    ...
    {
      title: "Vases and Planters",
      href: "/products/search/Potato"
    },
    {
      title: "Candles and Fragnance",
      href: "/products/search/Potato"
    }, {
...
export const mainCarouselData = [{
...
},
 {
  ...
  title: "Modern Furniture",
  subTitle: "A Beautiful House_",
  imgUrl: "/assets/images/headers/furniture-2.jpg",
  description: `How employees, surely the a said drops. Bathroom expected that systems let place. Her safely been little. Enterprises flows films it a fly the of wasn't designer the her thought. Enterprises flows films it a fly the of wasn't designer.`,
  buttonText: "Shop Now",
  buttonLink:"#"
},
...
export const products = [
  ...
  discount: 5,
  thumbnail: "/assets/images/furniture-products/furniture-29.jpg",
  images: ["/assets/images/furniture-products/furniture-29.jpg", "/assets/images/furniture-products/furniture-29.jpg"],
  categories: [],
  status: null,
  reviews: [],
  rating: 4,
  ...
  shop: {
    ...
    user: {
      ...
      email: "Cory.Krtzmann51@yahoo.com",
