...
export default function BannerCard({
  ...
  return <BannerCardWrapper bgColor={bgColor}>
      <div className="content">
        <Paragraph fontWeight={600} fontSize={{
        xl: 20,
        sm: 16,
        xs: 14
      }}>
        ...
        <H6 lineHeight={1} fontWeight={700} fontSize={{
        xl: 33,
        sm: 27,
        xs: 22
      }}>
        ...
        <Paragraph mt={1} mb={2} fontWeight={700} color="error.main" fontSize={{
        xl: 24,
        sm: 20,
        xs: 18
      }}>
