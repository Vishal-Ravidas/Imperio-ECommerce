  ...
  return <Container>
      <Grid container spacing={3} pt={3}>
        <Grid item md={6} xs={12}>
          <BannerCard bgColor="#D7E2F2" price="$1.00 – $55.00" title="Medicine Product" tag="Home Medical Supplies" ImageComponent={<LazyImage alt="Banner" src={bannerOne} />} />
        </Grid>

        <Grid item md={6} xs={12}>
          <BannerCard bgColor="#E6F5F6" price="$1.00 – $55.00" title="Medicine Product" tag="Home Medical Supplies" ImageComponent={<LazyImage alt="Banner" src={bannerTwo} />} />
        </Grid>
      </Grid>
    </Container>;
}