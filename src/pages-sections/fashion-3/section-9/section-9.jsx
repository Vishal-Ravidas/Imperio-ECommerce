...
import ProductCard from "./product-card"; // STYLED COMPONENT

import { BannerWrapper } from "./styles"; // API FUNCTIONS

import api from "utils/__api__/fashion-3"; // IMPORT BANNER IMAGE
