...
import { RootStyle } from "./styles"; // CUSTOM UTILS LIBRARY FUNCTIONS

import { calculateDiscount, currency } from "lib"; // CUSTOM DATA MODEL
...
export default function ProductCard({
  ...
  return <RootStyle>
      ...
      <div className="content">
        {categories.length ? <Paragraph color="grey.600" fontSize={12}>
            {categories[0]}
          </Paragraph> : null}
        ...
        <Paragraph mt={1} fontSize={16} fontWeight={700}>
          ...
          {discount ? <Span ml={1} component="del" fontWeight={600} color="grey.600">
              {currency(price)}
            </Span> : null}
        </Paragraph>
      </div>
