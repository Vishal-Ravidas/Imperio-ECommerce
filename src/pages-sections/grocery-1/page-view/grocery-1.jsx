...
import axios from "../../../utils/axiosInstance"; // GLOBAL CUSTOM COMPONENTS
...
export default function GroceryOnePageView(props) {
  ...
  const SideNav = <SideNavbar navList={props.grocery1NavList} handleSelect={handleSelectCategory} />;
  return <div className="bg-white">
      ...
      <Section4 products={filterProducts} title={selectedCategory} /> : <Fragment>
            {
