  ...
  return <Container className="pt-2 mb-4">
      ...
      <Grid container spacing={3}>
        ...
        <Grid item md={3} sm={6} xs={12}>
          <Card4 title="Secure Payment" Icon={CreditCardVerifiedIcon} body="100% secured payment & privacy" />
        </Grid>
        ...
        <Grid item md={3} sm={6} xs={12}>
          <Card4 title="Great Feedback" Icon={FeedbackThumbsUpIcon} body="More than 97% positive & happy customers" />
        </Grid>
