...
import HealthBeautySideNav from "components/page-sidenav/health-beauty-side-nav"; // LOCAL CUSTOM COMPONENTS

import Section1 from "../section-1";
import Section2 from "../section-2";
import Section3 from "../section-3";
import Section4 from "../section-4";
import Section5 from "../section-5"; // API FUNCTIONS
...
export default async function HealthBeautyPageView() {
  ...
  const mainCarouselData = await api.getMainCarousel(); // SIDE NAVBAR COMPONENT
