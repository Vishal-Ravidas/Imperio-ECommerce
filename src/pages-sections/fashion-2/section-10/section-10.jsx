...
import ListBlock from "./block"; // API FUNCTIONS

import api from "utils/__api__/fashion-2";
export default async function Section10() {
  const [saleProducts, latestProducts, popularProducts, bestWeekProducts] = await Promise.all([api.getSaleProducts(), api.getLatestProducts(), api.getPopularProducts(), api.getBestWeekProducts()]);
